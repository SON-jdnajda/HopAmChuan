...
namespace WebChord.Migrations
{
    ...
    partial class HopAmChuan2ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebChord.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.Chord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.ChordGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.ChordType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.GroupOfSinger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.GuestWatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.ListOfImageUrl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.Singer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SingerGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SingerTone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.Song", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SongAuthor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SongCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SongChord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SongSinger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.SongUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.TheCountryThatComposesTheSong", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.Tone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebChord.Models.Chord", b =>
                {
                    b.HasOne("WebChord.Models.ChordGroup", "IdChordGroupNavigation")
                        .WithMany("Chords")
                        .HasForeignKey("IdChordGroup")
                        .HasConstraintName("FK_ChordGroup_Chord");

                    b.HasOne("WebChord.Models.ChordType", "IdChordTypeNavigation")
                        .WithMany("Chords")
                        .HasForeignKey("IdChordType")
                        .HasConstraintName("FK_ChordType_Chord");

                    b.HasOne("WebChord.Models.ListOfImageUrl", "IdListOfImageUrlsNavigation")
                        .WithMany("Chords")
            ...
            modelBuilder.Entity("WebChord.Models.SingerGroup", b =>
                {
                    b.HasOne("WebChord.Models.GroupOfSinger", "IdGroupOfSingerNavigation")
                        .WithMany("SingerGroups")
                        .HasForeignKey("IdGroupOfSinger")
                        .HasConstraintName("FK_GroupOfSinger_SingerGroup");

                    b.HasOne("WebChord.Models.Singer", "IdSingerNavigation")
                        .WithMany("SingerGroups")
            ...
            modelBuilder.Entity("WebChord.Models.SingerTone", b =>
                {
                    ...
                    b.HasOne("WebChord.Models.Tone", "IdToneNavigation")
                        .WithMany("SingerTones")
            ...
            modelBuilder.Entity("WebChord.Models.Song", b =>
                {
                    b.HasOne("WebChord.Models.TheCountryThatComposesTheSong", "IdCountryComposesNavigation")
                        .WithMany("Songs")
            ...
            modelBuilder.Entity("WebChord.Models.SongAuthor", b =>
                {
                    b.HasOne("WebChord.Models.Author", "IdAuthorNavigation")
                        .WithMany("SongAuthors")
                        .HasForeignKey("IdAuthor")
                        .HasConstraintName("FK_Author_SongAuthor");

                    b.HasOne("WebChord.Models.Song", "IdSongNavigation")
                        .WithMany("SongAuthors")
            ...
            modelBuilder.Entity("WebChord.Models.SongCategory", b =>
                {
                    b.HasOne("WebChord.Models.Category", "IdCategoryNavigation")
            ...
            modelBuilder.Entity("WebChord.Models.SongChord", b =>
                {
                    b.HasOne("WebChord.Models.Chord", "IdChordNavigation")
                        .WithMany("SongChords")
            ...
            modelBuilder.Entity("WebChord.Models.SongUser", b =>
                {
                    ...
                    b.HasOne("WebChord.Models.User", "IdUserNavigation")
                        .WithMany("SongUsers")
            ...
            modelBuilder.Entity("WebChord.Models.User", b =>
                {
                    b.HasOne("WebChord.Models.UserGroup", "IdUserGroupNavigation")
                        .WithMany("Users")
