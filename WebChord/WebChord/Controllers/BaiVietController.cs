...
using WebChord.ViewModels;

using static System.Net.Mime.MediaTypeNames;

namespace WebChord.Controllers
{
    public class BaiVietController : Controller
    {
        ...
        public IActionResult ChiTiet(int? id)
        {
            ...
            //try
            //{
            //    Console.WriteLine("Raw JSON string: " + model.Lyrics); // Log the raw JSON string
            //    lyrics = JsonConvert.DeserializeObject<List<Lyric>>(model.Lyrics);
            //    Console.WriteLine("Parsed lyrics: " + JsonConvert.SerializeObject(lyrics)); // Log the parsed object
            //}
